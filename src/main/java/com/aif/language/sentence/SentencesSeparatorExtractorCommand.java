...
class SentencesSeparatorExtractorCommand extends BasicTextCommand {
  ...
  public Void apply(final String... args) {
    ...
    final ISeparatorExtractor separatorExtractor =
    ...
    final List<Set<Character>> separatorsGroupsUnclasify =
        separatorsGrouper.group(tokens, separators);
    final Map<ISeparatorGroupsClassifier.Group, Set<Character>> separatorsGroups =
        sentenceSeparatorGroupsClassificatory.classify(tokens, separatorsGroupsUnclasify);
